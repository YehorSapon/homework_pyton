...
print (b1)
b2 = (a1 or a2 or a3 or "Вы ўвялі ўсе нулі!!!")
print ("Першае не нулявое значэнне - ", b2)
if a1 >= a2 + a3:
    print ("Розніца паміж першай лічбай і сумай другой і трэцяй лічбай (a-b-c):", a1 - a2 - a3)
else:
    print ("Розніца паміж сумай другой і трэццяй лічбай і першай лічбай (b+c-a):", - a1 + a2 + a3)
